...
file_put_contents('../orders/hoya/narudzbenica_Hoya_' . $imeKorisnika . '_' . date("d.m.Y_H.i") . '.xls', $schema_insert);
...
// attachment name
$filename = "narudzbenica_Hoya_" . $imeKorisnika . "_" . date("d.m.Y_H.i") . ".xls";

//$pdfdoc is PDF generated by FPDF
$attachment = chunk_split(base64_encode(file_get_contents('../orders/hoya/narudzbenica_Hoya_' . $imeKorisnika . '_' . date("d.m.Y_H.i") . '.xls')));
