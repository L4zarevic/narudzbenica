...
if (mail($to, $subject, $body, $headers)) {
  ...
  $stmt3 = $conn->prepare('INSERT INTO mojaopt_vpnarudzbenica.narudzbenica_hoya (od_os_ou,vrsta_sociva,dizajn,visina,segment,baza,indeks,precnik,sph,cyl,ugao,adicija,jm,kolicina,tretman1,tretman2,pd,mpc,broj_naloga,napomena,komitenti_radnje,dobavljac,mjesto_isporuke) 
    SELECT od_os_ou,vrsta_sociva,dizajn,visina,segment,baza,indeks,precnik,sph,cyl,ugao,adicija,jm,kolicina,tretman1,tretman2,pd,mpc,broj_naloga,napomena,mojaopt_narudzbenica.narudzbenica_hoya.mjesto_isporuke,mojaopt_optike.korisnici.hoya,mojaopt_optike.korisnici.mjesto_isporuke FROM mojaopt_narudzbenica.narudzbenica_hoya
    JOIN mojaopt_optike.korisnici 
    ON narudzbenica_hoya.IDKorisnika = mojaopt_optike.korisnici.ID 
    WHERE IDKorisnika =?');
