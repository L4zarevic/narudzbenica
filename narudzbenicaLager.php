...
if (mysqli_num_rows($result) > 0) {
    echo "<a  onClick=\"javascript: return confirm('Želite da pošaljete narudžbu? ');\" href='../narudzbenica/mail.php' class='btn btn-success'><i class='fa fa-paper-plane'></i> Pošalji narudžbu</a>";
}
