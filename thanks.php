            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="thankYou">
                        ...
                        <p style="font-size:20px;color:#5C5C5C;">Vaša narudžbina je poslata na email <a href="mailto:narudzba@mojaoptika.com">narudzba@mojaoptika.com</a></p>&nbsp;&nbsp;&nbsp;&nbsp;<a id="homeButton" href="index.php" class="btn btn-success"> Idi na početnu </a> <br><br>
                    </div>
                </div>
