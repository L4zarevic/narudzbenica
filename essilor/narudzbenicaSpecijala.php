...
echo "<div class='table-wrapper-scroll-y'><table class='narudzbenica-tabela' id='narudzbenica'><thead><tr><th class='tg-0lax'>Od/Os/Ou</th><th class='tg-0lax'>Vrsta \nsoč.</th><th class='tg-0lax'>Dizajn</th><th class='tg-0lax'>PRL/OCHT</th><th class='tg-0lax'>Segm.</th><th class='tg-0lax'>Baza</th><th class='tg-0lax'>Index</th><th class='tg-0lax'>Prečn.</th><th class='tg-0lax'>SPH</th><th class='tg-0lax'>CYL</th><th class='tg-0lax'>Ugao</th><th class='tg-0lax'>Add</th><th class='tg-0lax'>JM</th><th class='tg-0lax'>Kol.</th><th class='tg-0lax'>Tr.1</th><th class='tg-0lax'>Tr.2</th><th class='tg-0lax'>PD</th><th class='tg-0lax'>Mjesto ispor.</th><th class='tg-0lax'>MPC po kom.</th><th class='tg-0lax'>Napomena</th><th class='tg-0lax'></th></tr></thead><tbody>";
...
if (mysqli_num_rows($result) > 0) {
    echo "<a  onClick=\"javascript: return confirm('Želite da pošaljete narudžbu? ');\" href='mail.php' class='btn btn-success'><i class='fa fa-paper-plane'></i> Pošalji narudžbu</a>";
}
