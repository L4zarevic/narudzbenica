...
while ($row = mysqli_fetch_object($result)) {
    ...
    echo "<td><i onclick='deleteRow(event);' title='Ukloni stavku' id='$row->ID'class='fas fa-trash fa-lg'></i></td>";
    echo "</tr>";
}
echo "</tbody>";
echo "</table>";
...
echo " <p id='info'>U tabeli je moguće unijeti / izmijeniti <strong>MPC po komadu</strong>,</br><strong>Broj radnog naloga</strong> i <strong>Napomenu</strong>. </br> Da bi potvrdili unos pritisnite ENTER na tastaturi.</br> Za brisanje stavke u tabeli, kliknite na ikonicu kantice <i class='fa fa-trash'></i></p>";
