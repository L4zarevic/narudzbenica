...
$stmt = $conn->prepare('SELECT * FROM narudzbenica WHERE IDKorisnika =? ORDER BY lag_spec ASC');
...
file_put_contents('narudzbenica_' . $imeKorisnika . '_' . date("d.m.Y") . '.xls', $schema_insert);
...
// attachment name
$filename = "narudzbenica_" . $imeKorisnika . "_" . date("d.m.Y") . ".xls";

//$pdfdoc is PDF generated by FPDF
$attachment = chunk_split(base64_encode(file_get_contents('narudzbenica_' . $imeKorisnika . '_' . date("d.m.Y") . '.xls')));
