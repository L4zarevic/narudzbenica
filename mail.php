...
// attachment name
$filename = "narudzbenica_" . $imeKorisnika . "_" . date("d.m.Y_H.i") . ".xls";

//$pdfdoc is PDF generated by FPDF
$attachment = chunk_split(base64_encode(file_get_contents('orders/narudzbenica_' . $imeKorisnika . '_' . date("d.m.Y_H.i") . '.xls')));
