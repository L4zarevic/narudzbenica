<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar"> <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
    ...
    <li class="nav-item active"> <a class="nav-link" href="../alcon/index.php"> <i class="fas fa-home"></i> <span>Početna</span></a> </li>
    <hr class="sidebar-divider">
    <div class="sidebar-heading"> Meni </div>
    <li class="nav-item"> 
        <a class="nav-link collapsed" href="../alcon/lenses.php" d data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo"> <i class="fas fa-eye"></i> <span>Narudžba</span> </a>
    </li>
    <hr class="sidebar-divider">
