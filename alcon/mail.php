...
$schema_insert .= '<h2>Narudžbenica - Alcon</h2>';
...
// attachment name
$filename = "narudzbenica_alcon_" . $imeKorisnika . "_" . date("d.m.Y_H.i") . ".html";

//$pdfdoc is PDF generated by FPDF
$attachment = chunk_split(base64_encode(file_get_contents('../orders/alcon/narudzbenica_alcon_' . $imeKorisnika . '_' . date("d.m.Y_H.i") . '.html')));
...
if (mail($to, $subject, $body, $headers)) {
  ...
  $message = "Narudzbenica - Alcon" . $eol;
