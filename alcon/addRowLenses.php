...
$stmt = $conn->prepare('INSERT INTO narudzbenica_alcon (IDKorisnika,od_os,period,tip,sph,cyl,ugao,bc,td,jm,kolicina,mjesto_isporuke,mpc,broj_naloga,napomena) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)');
