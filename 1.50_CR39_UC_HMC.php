<!DOCTYPE html>
<html lang="en">
<?php include '../narudzbenica/modules/header.php'; ?>
...
<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo"> <i class="fas fa-glasses"></i> <span>Lagerska stakla</span> </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="mr-2 d-none d-lg-inline text-gray-600 small">Ulogovani ste kao <b><?php echo $imeKorisnika; ?></b> <i class="fas fa-user"></i></span></a>
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal"> <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i> Odjava </a>
                            </div>
                        </li>
                    </ul>
                </nav>
                <div class="container-fluid">
                            ...
                            <table class="table table-bordered table-condensed4">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class='poljeTabele'><input type='text' id='2363' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2364' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">2.75</td>
                                        <td class='poljeTabele'><input type='text' id='2365' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2366' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2367' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2368' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2369' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2370' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2371' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2372' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2373' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">2.50</td>
                                        <td class='poljeTabele'><input type='text' id='2374' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2375' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2376' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2377' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2378' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2379' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2380' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2381' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2382' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">2.25</td>
                                        <td class='poljeTabele'><input type='text' id='2383' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2384' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2385' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2386' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2387' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2388' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2389' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2390' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2391' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">2.00</td>
                                        <td class='poljeTabele'><input type='text' id='2392' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2393' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2394' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2395' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2396' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2397' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2398' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2399' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2400' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">1.75</td>
                                        <td class='poljeTabele'><input type='text' id='2401' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2402' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2403' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2404' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2405' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2406' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2407' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2408' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2409' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">1.50</td>
                                        <td class='poljeTabele'><input type='text' id='2410' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2411' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2412' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2413' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2414' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2415' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2416' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2417' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2418' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">Sph</td>
                                        <td class="poljeTabele">0.00</td>
                            ...
                            <table class="table table-bordered table-condensed">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class='poljeTabele'><input type='text' id='2419' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">7.75</td>
                                        <td class='poljeTabele'><input type='text' id='2420' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2421' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">7.50</td>
                                        <td class='poljeTabele'><input type='text' id='2422' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2423' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2424' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">7.25</td>
                                        <td class='poljeTabele'><input type='text' id='2425' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2426' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2427' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2428' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">7.00</td>
                                        <td class='poljeTabele'><input type='text' id='2429' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2430' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2431' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2432' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2433' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">6.75</td>
                                        <td class='poljeTabele'><input type='text' id='2434' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2435' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2436' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2437' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2438' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2439' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">6.50</td>
                                        <td class='poljeTabele'><input type='text' id='2440' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2441' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2442' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2443' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2444' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2445' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2446' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">6.25</td>
                                        <td class='poljeTabele'><input type='text' id='2447' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2448' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2449' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2450' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2451' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2452' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2453' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2454' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">6.00</td>
                                        <td class='poljeTabele'><input type='text' id='2455' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2456' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2457' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2458' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2459' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2460' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2461' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2462' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2463' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">5.75</td>
                                        <td class='poljeTabele'><input type='text' id='2464' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2465' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2466' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2467' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2468' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2469' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2470' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2471' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2472' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">5.50</td>
                                        <td class='poljeTabele'><input type='text' id='2473' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2474' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2475' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2476' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2477' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2478' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2479' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2480' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2481' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">5.25</td>
                                        <td class='poljeTabele'><input type='text' id='2482' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2483' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2484' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2485' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2486' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2487' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2488' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2489' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2490' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">5.00</td>
                                        <td class='poljeTabele'><input type='text' id='2491' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2492' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2493' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2494' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2495' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2496' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2497' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2498' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2499' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">4.75</td>
                                        <td class='poljeTabele'><input type='text' id='2500' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2501' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2502' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2503' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2504' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2505' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2506' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2507' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2508' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">4.50</td>
                                        <td class='poljeTabele'><input type='text' id='2509' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2510' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2511' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2512' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2513' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2514' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2515' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2516' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2517' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">4.25</td>
                                        <td class='poljeTabele'><input type='text' id='2518' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2519' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2520' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2521' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2522' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2523' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2524' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2525' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2526' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">4.00</td>
                                        <td class='poljeTabele'><input type='text' id='2527' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2528' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2529' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2530' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2531' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2532' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2533' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2534' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2535' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">3.75</td>
                                        <td class='poljeTabele'><input type='text' id='2536' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2537' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2538' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2539' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2540' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2541' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2542' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2543' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2544' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">3.50</td>
                                        <td class='poljeTabele'><input type='text' id='2545' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2546' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2547' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2548' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2549' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2550' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2551' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2552' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2553' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">3.25</td>
                                        <td class='poljeTabele'><input type='text' id='2554' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2555' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2556' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2557' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2558' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2559' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2560' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2561' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2562' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">3.00</td>
                                        <td class='poljeTabele'><input type='text' id='2563' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2564' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2565' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2566' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2567' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2568' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2569' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2570' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2571' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">2.75</td>
                                        <td class='poljeTabele'><input type='text' id='2572' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2573' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2574' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2575' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2576' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2577' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2578' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2579' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2580' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">2.50</td>
                                        <td class='poljeTabele'><input type='text' id='2581' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2582' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2583' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2584' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2585' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2586' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2587' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2588' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2589' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">2.25</td>
                                        <td class='poljeTabele'><input type='text' id='2590' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2591' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2592' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2593' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2594' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2595' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2596' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2597' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2598' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">2.00</td>
                                        <td class='poljeTabele'><input type='text' id='2599' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2600' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2601' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2602' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2603' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2604' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2605' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2606' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2607' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">Sph</td>
                                        <td class="poljeTabele">0.00</td>
                        ...
                        <h5 id>
                            ...
                            <table class="table table-bordered table-condensed">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="poljeTabele">8.00</td>
                                        <td class='poljeTabele'><input type='text' id='2608' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">7.75</td>
                                        <td class='poljeTabele'><input type='text' id='2609' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2610' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">7.50</td>
                                        <td class='poljeTabele'><input type='text' id='2611' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2612' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2613' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">7.25</td>
                                        <td class='poljeTabele'><input type='text' id='2614' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2615' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2616' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2617' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">7.00</td>
                                        <td class='poljeTabele'><input type='text' id='2618' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2619' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2620' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2621' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2622' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">6.75</td>
                                        <td class='poljeTabele'><input type='text' id='2623' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2624' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2625' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2626' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2627' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2628' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">6.50</td>
                                        <td class='poljeTabele'><input type='text' id='2629' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2630' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2631' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2632' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2633' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2634' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2635' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">6.25</td>
                                        <td class='poljeTabele'><input type='text' id='2636' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2637' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2638' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2639' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2640' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2641' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2642' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2643' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">6.00</td>
                                        <td class='poljeTabele'><input type='text' id='2644' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2645' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2646' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2647' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2648' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2649' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2650' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2651' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2652' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">5.75</td>
                                        <td class='poljeTabele'><input type='text' id='2653' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2654' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2655' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2656' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2657' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2658' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2659' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2660' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2661' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">5.50</td>
                                        <td class='poljeTabele'><input type='text' id='2662' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2663' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2664' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2665' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2666' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2667' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2668' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2669' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2670' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">5.25</td>
                                        <td class='poljeTabele'><input type='text' id='2671' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2672' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2673' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2674' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2675' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2676' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2677' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2678' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2679' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">5.00</td>
                                        <td class='poljeTabele'><input type='text' id='2680' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2681' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2682' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2683' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2684' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2685' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2686' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2687' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2688' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">4.75</td>
                                        <td class='poljeTabele'><input type='text' id='2689' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2690' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2691' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2692' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2693' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2694' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2695' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2696' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2697' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">4.50</td>
                                        <td class='poljeTabele'><input type='text' id='2698' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2699' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2700' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2701' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2702' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2703' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2704' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2705' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2706' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">4.25</td>
                                        <td class='poljeTabele'><input type='text' id='2707' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2708' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2709' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2710' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2711' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2712' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2713' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2714' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2715' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">4.00</td>
                                        <td class='poljeTabele'><input type='text' id='2716' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2717' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2718' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2719' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2720' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2721' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2722' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2723' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2724' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">3.75</td>
                                        <td class='poljeTabele'><input type='text' id='2725' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2726' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2727' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2728' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2729' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2730' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2731' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2732' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2733' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">3.50</td>
                                        <td class='poljeTabele'><input type='text' id='2734' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2735' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2736' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2737' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2738' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2739' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2740' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2741' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2742' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">3.25</td>
                                        <td class='poljeTabele'><input type='text' id='2743' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2744' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2745' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2746' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2747' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2748' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2749' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2750' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2751' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">3.00</td>
                                        <td class='poljeTabele'><input type='text' id='2752' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2753' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2754' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2755' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2756' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2757' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2758' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2759' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2760' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">2.75</td>
                                        <td class='poljeTabele'><input type='text' id='2761' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2762' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2763' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2764' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2765' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2766' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2767' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2768' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2769' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">2.50</td>
                                        <td class='poljeTabele'><input type='text' id='2770' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2771' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2772' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2773' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2774' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2775' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2776' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2777' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2778' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">2.25</td>
                                        <td class='poljeTabele'><input type='text' id='2779' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2780' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2781' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2782' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2783' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2784' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2785' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2786' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2787' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">2.00</td>
                                        <td class='poljeTabele'><input type='text' id='2788' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2789' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2790' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2791' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2792' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2793' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2794' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2795' class='form-control' /></td>
                                        <td class='poljeTabele'><input type='text' id='2796' class='form-control' /></td>
                                    </tr>
                                    <tr>
                                        <td class="poljeTabele">Sph</td>
                                        <td class="poljeTabele">0.00</td>
                    ...
                    <hr>
                    <?php include 'narudzbenicaLager.php'; ?>
                </div>
            </div>
        </div>
