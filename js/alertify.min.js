...
var $odOsOu = $('#select1').find("option:selected").text();
var $vrstaSociva = $('#select2').find("option:selected").text();
var $dizajn = document.getElementById("dizajn").value;
var $visina = $('#select5').find("option:selected").text();
var $segment = document.getElementById("segment").value;
var $pd = document.getElementById("pd").value;
var $baza = $('#select7').find("option:selected").text();
...
var $jm = $('#select14').find("option:selected").text();
var $kolicina = document.getElementById("kolicina").value;
var $tretman1 = document.getElementById("tretman1").value;
var $tretman2 = document.getElementById("tretman2").value;
var $mpc = document.getElementById("mpc").value;
var $napomena = document.getElementById("napomena").value;
...
var $id_stavke=document.getElementById("id_stavke").value;
var inputVal="";
if ($id_stavke.length == 0){
...
if (isNaN(document.getElementById("kolicina").value)) {
 ...
 var inputVal = $odOsOu + "###" + $vrstaSociva + "###" + $materijal + "###" + $sph + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $napomena;
        $.ajax({
          type: 'POST',
