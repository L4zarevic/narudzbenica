...
var $odOsOu = $('#select1').find("option:selected").text();
var $vrstaSociva = $('#select2').find("option:selected").text();
var $materijal = document.getElementById("materijal").value;
...
var $isporuka = $('#isporuka').find("option:selected").text();
...
var inputVal = $odOsOu + "###" + $vrstaSociva + "###" + $dizajn + "###" + $visina + "###" + $segment + "###" + $baza + "###" + $indeks + "###" + $materijal + "###" + $precnik1 + "###" + $precnik2 + "###" + $sph + "###" + $cyl + "###" + $ugao + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $tretman1 + "###" + $tretman2 + "###" + $pd + "###" + $isporuka + "###" + $mpc + "###" + $napomena;
