...
function deleteRow(){var a=event.srcElement.id;alertify.confirm("Potvrda brisanja","Da li želite da uklonite stavku?",function(){$.ajax({type:"POST",url:"deleteRow.php",dataType:"json",data:{stavka:a},success:function(){location.reload()},error:function(){location.reload()}})},function(){})}
...
alertify.alert('Niste unijeli sve potrebne parametre',"Obavezna polja za unos su: - Od/Os/Ou - Vrsta sočiva - Vrsta materija - Količina");
return false;
}
...
var inputVal="";
if ($id_stavke.length == 0){
 inputVal = $odOsOu + "###" + $vrstaSociva + "###" + $materijal + "###" + $sph + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $napomena;
        $.ajax({
          type: 'POST',
          ...
          error: function() {
            window.location.href="../poloptic/lager_bifocal_progresiv.php?msg=2";
          }
        });
}else {
	inputVal = $odOsOu + "###" + $vrstaSociva + "###" + $materijal + "###" + $sph + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $napomena + "###" + $id_stavke;
        $.ajax({
          type: 'POST',
