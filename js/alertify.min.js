...
$(document).keypress(function(e) {if (e.which == 13) {var inputVal = 0;for (var i = 1; i <= 2362; i++) {if (document.getElementById(i).value.length != 0) {if (document.getElementById(i).value > 0) {if (!isNaN(document.getElementById(i).value)) {inputVal = document.getElementById(i).value + "#" + i;add(inputVal);}}}}}});
...
function checkForm(){var e=$("#select1").find("option:selected").text(),t=$("#select2").find("option:selected").text(),n=$("#select5").find("option:selected").text(),l=$("#select6").find("option:selected").text(),o=$("#select3").find("option:selected").text(),i=$("#select4").find("option:selected").text(),d=document.getElementById("bazaSociva").value,a=$("#select7").find("option:selected").text(),c=$("#select8").find("option:selected").text(),s=document.getElementById("kolicina").value,u=$("#select9").find("option:selected").text(),r=$("#select10").find("option:selected").text(),p=document.getElementById("ugaoCilindra").value,f=$("#select11").find("option:selected").text(),m=$("#select12").find("option:selected").text(),x=(s=document.getElementById("kolicina").value,$("#select13").find("option:selected").text()),v=$("#select14").find("option:selected").text(),g=document.getElementById("napomena").value;if(0==a.selectedIndex?document.getElementById("select8").value:0==c.selectedIndex?document.getElementById("select7").value:1,0==e.length||0==t.length||0==l.length||0==o.length||0==i.length||0==s)return alertify.alert("Niste unijeli sve potrebne parametre","Obavezna polja za unos su: - Od/Os/Ou - Vrsta sočiva - Vrsta materijala - Dizajn - Index - Prečnik - Količina"),!1;if(isNaN(document.getElementById("kolicina").value))return alertify.alert("Greška","Neispravan unos količine"),!1;var y=e+"###"+t+"###"+i+"###"+n+"###"+d+"###"+l+"###"+o+"###"+a+"###"+c+"###"+u+"###"+r+"###"+p+"###"+f+"###"+m+"###"+s+"###"+x+"###"+v+"###"+g;$.ajax({type:"POST",url:"addRowSpecial.php",dataType:"json",data:{stavka:y},success:function(){location.reload()},error:function(){location.reload()}})}
