...
function getValue(){var e,t;13==event.keyCode&&(t=(e=event.srcElement.id)+"#"+document.getElementById(e).value,$.ajax({type:"POST",url:"../poloptic/updateRow.php",dataType:"json",data:{stavka:t},success:function(){location.reload()},error:function(){location.reload()}}))}
//Metod za brisanje reda u tabeli narudzbenice
function deleteRow(){var a=event.srcElement.id;alertify.confirm("Potvrda brisanja","Da li želite da uklonite stavku?",function(){$.ajax({type:"POST",url:"../poloptic/deleteRow.php",dataType:"json",data:{stavka:a},success:function(){location.reload()},error:function(){location.reload()}})},function(){})}
