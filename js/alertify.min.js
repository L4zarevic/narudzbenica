...
if (isNaN(document.getElementById("kolicina").value)) {
 ...
 var inputVal = $odOsOu + "###" + $vrstaSociva + "###" + $dizajn + "###" + $visina + "###" + $baza + "###" + $indeks + "###" + $materijal + "###" + $precnik1 + "###" + $precnik2 + "###" + $sph + "###" + $cyl + "###" + $ugao + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $tretman1 + "###" + $tretman2 + "###" + $napomena;
        $.ajax({
          type: 'POST',
...
//Highlighting row and column
	  ...
	  for(var i=1;i<=8;i++){
        ...
        //select row
        $row.find('td:eq(0)').addClass('selected');
