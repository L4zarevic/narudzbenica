...
function checkForm() {
    ...
    if ($id_stavke.length == 0) {
        inputVal = $odOsOu + "###" + $vrstaSociva + "###" + $dizajn + "###" + $visina + "###" + $segment + "###" + $baza + "###" + $indeks + "###" + $materijal + "###" + $precnik1 + "###" + $precnik2 + "###" + $sph + "###" + $cyl + "###" + $ugao + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $tretman1 + "###" + $tretman2 + "###" + $pd + "###" + $napomena;
        $.ajax({
            type: 'POST',
		...
		inputVal = $odOsOu + "###" + $vrstaSociva + "###" + $dizajn + "###" + $visina + "###" + $segment + "###" + $baza + "###" + $indeks + "###" + $materijal + "###" + $precnik1 + "###" + $precnik2 + "###" + $sph + "###" + $cyl + "###" + $ugao + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $tretman1 + "###" + $tretman2 + "###" + $pd + "###" + $napomena + "###" + $id_stavke;
        $.ajax({
            type: 'POST',
...
inputVal = $odOsOu + "###" + $vrstaSociva + "###" + $dizajn + "###" + $visina + "###" + $segment + "###" + $baza + "###" + $indeks + "###" + $precnik1 + "###" + $precnik2 + "###" + $sph + "###" + $cyl + "###" + $ugao + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $tretman1 + "###" + $tretman2 + "###" + $pd + "###" + $mpc + "###" + $napomena;
 ...
 $.ajax({
	...
	inputVal = $odOsOu + "###" + $vrstaSociva + "###" + $dizajn + "###" + $visina + "###" + $segment + "###" + $baza + "###" + $indeks + "###" + $precnik1 + "###" + $precnik2 + "###" + $sph + "###" + $cyl + "###" + $ugao + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $tretman1 + "###" + $tretman2 + "###" + $pd + "###" + $mpc + "###" + $napomena + "###" + $id_stavke;
	 $.ajax({
          type: 'POST',
    ...
    for (var i = 1; i < table.rows.length; i++) {
        table.rows[i].onclick = function() {
           ...
           if (window.event.ctrlKey) {
            ...
            document.getElementById("napomena").value = this.cells[19].innerHTML;
