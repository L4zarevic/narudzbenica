...
if($kolicina == 0){
    ...
    if (($odOsOu.length == 0) && ($vrstaSociva.length == 0) && ($indeks.length == 0) && ($materijal.length == 0) && ($dizajn.length == 0) && ($kolicina == 0)) {
		
        alertify.alert('Niste unijeli sve potrebne parametre', "Obavezna polja za unos su: - Od/Os/Ou - Vrsta sočiva - Vrsta materijala - Dizajn - Index - Prečnik - Količina");
...
if (($odOsOu.length  == 0) || ($vrstaSociva.length == 0) || ($indeks.length == 0) || ($dizajn.length == 0) || ($kolicina == 0)) {
alertify.alert('Niste unijeli sve potrebne parametre',"Obavezna polja za unos su: - Od/Os/Ou - Vrsta sočiva - Dizajn - Index - Prečnik - Količina");
return false;
}
