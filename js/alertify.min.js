...
function checkForm(){var e=$("#select1").find("option:selected").text(),t=$("#select2").find("option:selected").text(),n=$("#select3").find("option:selected").text(),l=$("#select4").find("option:selected").text(),o=$("#select5").find("option:selected").text(),i=$("#select7").find("option:selected").text(),d=$("#select8").find("option:selected").text(),c=$("#select9").find("option:selected").text(),a=$("#select10").find("option:selected").text(),s=document.getElementById("kolicina").value,r=$("#select11").find("option:selected").text(),u=$("#select12").find("option:selected").text(),p=document.getElementById("ugaoCilindra").value,f=$("#select13").find("option:selected").text(),x=$("#select14").find("option:selected").text(),m=(s=document.getElementById("kolicina").value,$("#select15").find("option:selected").text()),v=$("#select16").find("option:selected").text(),g=document.getElementById("napomena").value;if(0==c.selectedIndex?document.getElementById("select10").value:0==a.selectedIndex?document.getElementById("select9").value:1,0==e.length||0==t.length||0==d.length||0==n.length||0==l.length||0==s)return alertify.alert("Niste unijeli sve potrebne parametre","Obavezna polja za unos su: - Od/Os/Ou - Vrsta sočiva - Vrsta materijala - Dizajn - Index - Prečnik - Količina"),!1;if(isNaN(document.getElementById("kolicina").value))return alertify.alert("Greška","Neispravan unos količine"),!1;var y=e+"###"+t+"###"+l+"###"+o+"###"+i+"###"+d+"###"+n+"###"+c+"###"+a+"###"+r+"###"+u+"###"+p+"###"+f+"###"+x+"###"+s+"###"+m+"###"+v+"###"+g;$.ajax({type:"POST",url:"addRowSpecial.php",dataType:"json",data:{stavka:y},success:function(){location.reload()},error:function(){location.reload()}})}
...
if (($odOsOu.length  == 0) || ($vrstaSociva.length == 0) || ($kolicina == 0)) {
alertify.alert('Niste unijeli sve potrebne parametre',"Obavezna polja za unos su: - Od/Os/Ou - Vrsta sočiva - Količina");
return false;
}
if (isNaN(document.getElementById("kolicina").value)) {
 ...
 var inputVal = $odOsOu + "###" + $vrstaSociva + "###" + $sph + "###" + $add + "###" + $jm + "###" + $kolicina + "###" + $napomena;
        $.ajax({
          type: 'POST',
