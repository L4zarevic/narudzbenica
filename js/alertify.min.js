        ...
        table.rows[i].onclick = function() {
            ...
            if (this.cells[0].innerHTML == "Spec") {
                ...
                if (window.event.ctrlKey) {
                    ...
                    $("#select2 option:contains(" + this.cells[2].innerHTML + ")").attr('selected', 'selected').change();
                    $("#select4 option:contains(" + this.cells[3].innerHTML + ")").attr('selected', 'selected').change();
                    ...
                    $("#select3 option:contains(" + this.cells[8].innerHTML + ")").attr('selected', 'selected').change();
                    ...
                    $("#select15 option:contains(" + this.cells[16].innerHTML + ")").attr('selected', 'selected').change();
                    $("#select16 option:contains(" + this.cells[17].innerHTML + ")").attr('selected', 'selected').change();
...
function updateEntireRow() {
    ...
    for (var i = 1; i < table.rows.length; i++) {
        table.rows[i].onclick = function() {
            ...
            $("#select2 option:contains(" + this.cells[1].innerHTML + ")").attr('selected', 'selected').change();
