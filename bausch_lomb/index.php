...
// $con = OpenCon();
// $stmt = $con->prepare('SELECT jj_access FROM korisnici WHERE ID =?');
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="companyInfo"> <img id="logo" src="../images/bausch_and_lomb.svg" class="image" alt="logo" style="width: 100%; height: 100%;">
