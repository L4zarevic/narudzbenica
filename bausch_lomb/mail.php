...
if (mail($to, $subject, $body, $headers)) {
  ...
  $stmt3 = $conn->prepare('INSERT INTO mojaopt_vpnarudzbenica.narudzbenica_bl (od_os,tip,sph,cyl,ugao,bc,td,jm,kolicina,mpc,broj_naloga,napomena,komitenti_radnje,dobavljac,mjesto_isporuke) 
  SELECT od_os,tip,sph,cyl,ugao,bc,td,jm,kolicina,mpc,broj_naloga,napomena,mojaopt_narudzbenica.narudzbenica_bausch_lomb.mjesto_isporuke,mojaopt_optike.korisnici.bl,mojaopt_optike.korisnici.mjesto_isporuke FROM mojaopt_narudzbenica.narudzbenica_bausch_lomb
  JOIN mojaopt_optike.korisnici 
  ON narudzbenica_bausch_lomb.IDKorisnika = mojaopt_optike.korisnici.ID 
  WHERE IDKorisnika =?');
