...
$schema_insert .= '<h2>Narudžbenica - Johnson & Johnson</h2>';
...
// attachment name
$filename = "narudzbenica_johnson_johnson_" . $imeKorisnika . "_" . date("d.m.Y_H.i") . ".html";

//$pdfdoc is PDF generated by FPDF
$attachment = chunk_split(base64_encode(file_get_contents('../orders/johnson_johnson/narudzbenica_johnson_johnson_' . $imeKorisnika . '_' . date("d.m.Y_H.i") . '.html')));
...
$body .= "Narudzbenica - Johnson & Johnson" . $eol;
...
if (mail($to, $subject, $body, $headers)) {
  ...
  $message = "Narudzbenica - Johnson & Johnson" . $eol;
...
$stmt3 = $conn->prepare('INSERT INTO mojaopt_vpnarudzbenica.narudzbenica_jj (od_os,tip,sph,cyl,ugao,bc,td,jm,kolicina,mpc,broj_naloga,napomena,komitenti_radnje,dobavljac,mjesto_isporuke) 
SELECT od_os,tip,sph,cyl,ugao,bc,td,jm,kolicina,mpc,broj_naloga,napomena,mojaopt_narudzbenica.narudzbenica_jj.mjesto_isporuke,mojaopt_optike.korisnici.jj,mojaopt_optike.korisnici.mjesto_isporuke FROM mojaopt_narudzbenica.narudzbenica_jj
JOIN mojaopt_optike.korisnici 
ON narudzbenica_jj.IDKorisnika = mojaopt_optike.korisnici.ID 
WHERE IDKorisnika =?');
...
////////////////////////////////////////////////////////////////////////////////////
  ...
  $stmt = $conn->prepare('DELETE FROM `narudzbenica_jj` WHERE IDKorisnika =?');
  $stmt->bind_param('i', $idKorisnika);
  $stmt->execute();
  if (mysqli_error($conn)) {
    die(mysqli_error($conn));
