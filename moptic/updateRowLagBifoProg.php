...
$stmt = $conn->prepare('UPDATE narudzbenica_moptic SET IDKorisnika=?,od_os_ou=?,vrsta_sociva=?,vrsta_materijala=?,sph=?,adicija=?,jm=?,kolicina=?,mjesto_isporuke=?,mpc=?,broj_naloga=?,napomena=? WHERE ID=?');
