        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">1.56 Photocromic HMC</h1>
                    <div class="tabela1">
                        <h5 id>1.56 Photocromic HMC 65mm</h5>
                        <h6 id="cyl">+Cyl</h6>
                    ...
                    <div class="tabela2">
                        <h5 id>1.56 Photocromic HMC 70mm</h5>
                        <h6 id="cyl">+Cyl</h6>
                        <table class="table table-bordered table-condensed">
                            <tbody>
                                <tr>
            ...
            function add(o) {
                $.ajax({
                    ...
                    error: function() {
                        location.reload(), window.location.href = "1.56_Photocromic_HMC.php?msg=2"
                    }
                })
            }
        </script>
